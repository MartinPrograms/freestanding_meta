...
// 28-07-2026 Modified by MartinPrograms on GitHub, changed includes to "fs_*", and added __detail::__statically_sized concept
...
#include "fs_optional.h"
#include <source_location>
#include <span>
#include "fs_string.h"
#include "fs_string_view.h"
#include "fs_vector.h"
...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<ranges::input_range _Rg>
    ...
    concept __statically_sized
      = requires(_Rg&& __r) {
        static_cast<char(*)[static_cast<size_t>(ranges::size(__r)) >= 0]>(nullptr);
      };
    } // namespace __detail
